    ...
    return (
        <Fragment>
            ...
            <td className="actions">
                <button className="btn edit-btn" title="Edit" onClick={() => onClick(user._id, UserListConstants.Edit)}>
                ...
                <button className="btn delete-btn" title="Delete" onClick={() => onClick(user._id, UserListConstants.Delete)}>
                ...
                <button className="btn info-btn" title="Info" onClick={() => onClick(user._id, UserListConstants.Details)}>
